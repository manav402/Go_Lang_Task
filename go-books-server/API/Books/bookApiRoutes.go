...
// BookApi consist of DB pointer,a service Struct which implement all the services and http handler methods 
type BookApi struct {
	DB          *utils.DBstruct
...
func (bookApi *BookApi) GetAllBook(res http.ResponseWriter, req *http.Request) {
...
// A http handler method
func (bookApi *BookApi) GetOneBook(res http.ResponseWriter, req *http.Request) {
...
func (bookApi *BookApi) CreateBook(res http.ResponseWriter, req *http.Request) {
...
func (bookApi *BookApi) EditBook(res http.ResponseWriter, req *http.Request) {
	var book models.Book
